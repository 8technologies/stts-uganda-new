  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        title: 'My seed Labs',
        path: '/qa/my-labs',
        requiredPermissions: [getPerm('quality_assurance', 'can_create_seed_stock')]
      },
      
      {
        title: 'Lab tests',
        path: '/qa/labs',
        requiredPermissions: [getPerm('quality_assurance', 'can_manage_seed_lab_inspection')]
      },
      {
        title: 'Seed labels',
        path: '/qa/seed-labels',
        requiredPermissions: [getPerm('quality_assurance', 'can_view_seed_labels')]
      },
