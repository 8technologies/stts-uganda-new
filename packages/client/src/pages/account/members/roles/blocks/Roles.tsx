  ...
  const items: IRolesItems = [
    ...
    },
    {
      badge: {
        size: "size-[44px]",
        badge: (
          <KeenIcon icon="delivery-24" className="text-1.5xl text-danger" />
        ),
    ...
    },
    {
      badge: {
        size: "size-[44px]",
        badge: (
          <KeenIcon icon="chart-line-up-2" className="text-1.5xl text-info" />
        ),
    ...
    },
    {
      badge: {
        size: "size-[44px]",
        badge: (
          <KeenIcon icon="design-1" className="text-1.5xl text-gray-500" />
        ),
        fill: "fill-gray-100",
