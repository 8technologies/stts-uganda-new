        ...
        <DialogBody className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col gap-1">
                <label className="form-label">Marketing of<span className="text-red-500">*</span></label>
                <Input
              ...
              <div className="flex flex-col gap-1">
                <label className="form-label">Land size (In Acres)<span className="text-red-500">*</span></label>
                <Input
        ...
        <DialogFooter className="flex items-center justify-between border-t pt-4">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleSubmit} disabled={!!saving}>
              <KeenIcon icon="tick-square" /> {saving ? 'Submit' : 'Submit Changes'}
            </Button>
          </div>
        </DialogFooter>
      </DialogContent>
