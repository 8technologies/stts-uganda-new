...
const SR6CreateDialog = ({ open, onOpenChange, onSave, saving }: ISR6EditDialogProps) => {
        ...
        <DialogBody className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                <label className="form-label">Crop history for the last three season or years<span className="text-red-500">*</span></label>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
              ...
              <div className="max-w-md">
                <div className="flex flex-col gap-2">
                  <label className="form-label text-gray-700 font-medium">Attach Other Documents<span className="text-red-500">*</span></label>
                  ...
                  >
                    ...
                    <input
                      ...
                      accept=".png,.jpg,.jpeg,.pdf"
                      onChange={(e) =>
                        handleChange("otherDocuments", e.target.files?.[0] || null)
                      }
                    />
                  </label>
                  ...
                  {values.otherDocuments && (
                    <p className="text-sm text-gray-600 mt-1">
                      Selected file: <span className="font-medium">{values.otherDocuments.name}</span>
                    </p>
                  )}
