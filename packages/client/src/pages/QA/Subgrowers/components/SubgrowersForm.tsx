...
const SubgrowersForm = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => (!open ? handleClose() : undefined)}>
      <SheetContent side="right" className="w-full sm:max-w-[840px] lg:max-w-[650px] overflow-y-auto">
        <SheetHeader className="mb-4">
          <SheetTitle>{title ? 'Create New Subgrower' : 'Edit Subgrower'}</SheetTitle>
        </SheetHeader>
        <div>
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Responsible Person 
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Field Name
                <span className="text-red-500">*</span>
              </label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Seed Class</label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Motherlot Number</label>
              <Input
                value={formData.motherlotNumber}
                onChange={(e) => handleInputChange('motherlotNumber', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Foundation Seed Source</label>
              <Input
                value={formData.foundationSeedSource}
                onChange={(e) => handleInputChange('foundationSeedSource', e.target.value)}
          ...
          <div className="mt-6 flex gap-3">
            ...
            <Button 
              ...
              disabled={loading}
            >
              {loading ? 'Please wait...' : (submitLabel ?? (initialValues ? 'Update Subgrower' : 'Create Subgrower'))}
            </Button>
          </div>
        </div>
      </SheetContent>
