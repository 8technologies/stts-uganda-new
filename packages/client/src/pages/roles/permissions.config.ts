...
export const MODULES_CONFIG: ModuleConfig[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: 'can_manage_seed_lab_inspection', label: 'Can manage Seed Lab Inspections' },
      { id: 'can_view_only_assigned_seed_lab_inspection', label: 'Can View Only Assigned Seed Lab Inspections' },
      { id: 'can_view_seed_lab_inspections', label: 'Can View Seed Lab Inspections' },
      { id: 'can_edit_seed_lab_inspections', label: 'Can Edit Seed Lab Inspections' },
      { id: 'can_delete_seed_lab_inspections', label: 'Can Delete Seed Lab Inspections' },
      { id: 'can_perform_seed_lab_inspections', label: 'Can Perform Seed Lab Inspections'},
      { id: 'can_receive_seed_lab_inspections', label: 'Can receive Seed Lab Inspections' },
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: 'can_view_only_assigned_seed_stock', label: 'Can View Only assigned Seed Stock' },
      ...
      { id: 'can_edit_examination_inspections', label: 'Can Perform Stock Examination Inspections' },
