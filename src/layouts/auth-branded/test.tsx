  ...
  return (
    <Fragment>
      <style>
        {`
          .branded-bg {
            background-image: linear-gradient(135deg, rgba(65, 61, 63, 0.99), rgba(65, 61, 63, 0.0)), url('https://seedtracker.net/assets/images/bg/background2.jpg');
            background-size: cover;
            background-blend-mode: multiply;
          }
          .dark .branded-bg {
            background-image: linear-gradient(135deg, rgba(23,96,45,0.95), rgba(40,184,98,0.9)), url('https://seedtracker.net/assets/images/bg/background2.jpg');
            background-size: cover;
            background-blend-mode: multiply;
          }
        `}
      ...
      <div className="grid lg:grid-cols-2 grow lg:min-h-screen lg:h-screen lg:overflow-hidden">
        ...
        <div className="lg:rounded-xl lg:border lg:border-gray-200 lg:m-5 order-1 lg:order-2 bg-top xxl:bg-center xl:bg-cover bg-no-repeat branded-bg lg:h-full">
