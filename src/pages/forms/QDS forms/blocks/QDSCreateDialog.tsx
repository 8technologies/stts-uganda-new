          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
              {[
                ...
                ['otherDocuments', 'Upload Certificate of Registration'],
                ['recommendationLetter', 'Upload Recommendation Letter from DAO'],
              ].map(([key, label]) => (
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {values[key] && (
                      <p className="text-sm text-gray-600 mt-1">
                        Selected file: <span className="font-medium">{values[key].name}</span>
                      </p>
                    )}

                    {values[key] && values[key].type?.startsWith('image/') && (
                      <img
                        src={URL.createObjectURL(values[key])}
                        alt={`${key} preview`}
