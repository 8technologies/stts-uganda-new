...
const SR6CreateDialog = ({ open, onOpenChange, onSave }: ISR6EditDialogProps) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <Select value={values.applicationCategory} onValueChange={(v) => handleChange('applicationCategory', v)}>
                  ...
                  <SelectContent>
                    <SelectItem value="Seed Producer">Seed Producer</SelectItem>
                    <SelectItem value="Plant breeder">Plant breeder</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              {/* <div className="flex flex-col gap-1">
